...
<div id="container" class="d-flex flex-row col-lg-12 col-md-12 col-sm-12 justify-content-center">
    ...
    if (!$clientes) {
        echo "<td colspan='9'><b>No existen clientes para mostrar</b></td>";
        ...
        foreach ($clientes as $key => $value) {
            ...
            echo "<td><a class='btn btn-warning mr-1 pt-0' href='editarcliente.php?dni=" . $value->getDni() . "'><img with='15px' src='img/edit.png'></a>
					<a class='btn btn-danger pt-0' href='borrarcliente.php?dni=" . $value->getDni() . "'><img with='15px' src='img/delete.png'></a></td>";
            echo "</tr>";
        }
    }
    echo "</table>";
